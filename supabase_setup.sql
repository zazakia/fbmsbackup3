...
CREATE POLICY "Allow all operations on customers" ON fbms.customers FOR ALL USING (true);
CREATE POLICY "Allow all operations on users" ON fbms.users FOR ALL USING (true);