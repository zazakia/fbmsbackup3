...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  admin: [
    ...
    { module: 'purchases', actions: ['view', 'create', 'edit', 'delete', 'approve', 'receive', 'configure-workflow'] },
  ...
  manager: [
    ...
    { module: 'purchases', actions: ['view', 'create', 'edit', 'approve', 'receive'] },
  ...
  accountant: [
    ...
    { module: 'reports', actions: ['view', 'export'] },
    { module: 'bir', actions: ['view', 'create', 'edit'] },
    { module: 'purchases', actions: ['view', 'receive'] },
